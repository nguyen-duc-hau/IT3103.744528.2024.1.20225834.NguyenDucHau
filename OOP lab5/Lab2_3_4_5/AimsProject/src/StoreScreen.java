...
import Lab2_3_4_5.AimsProject.src.aims.media.*;
...
public class StoreScreen extends JFrame {
    ...
    public static void initSetup() {
        ...
        DigitalVideoDisc dvd3 = new DigitalVideoDisc("Aladdin", "Animation", null,  
                                                    0, 18.99f);
        store.addMedia(dvd1);
        store.addMedia(dvd2);
        store.addMedia(dvd3);
        ...
        Book book2 = new Book("On the Origin of Time: Stephen Hawking's Final Theory", 
                            "Science", 120.00f);
        store.addMedia(book);
        ...
        CompactDisc cd2 = new CompactDisc("The Gods We Can Touch", "Music","Aurora", 
                                            2000.22f);
    ...
    public StoreScreen(Store store) {
        ...
        setTitle("Nguyễn Đức Hậu - 20225834 - Store");
		setSize(1024, 768);
		setVisible(true);
